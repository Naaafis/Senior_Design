...
//  Serial.print("finished max upload initializing");
//  //upload file in even chunks    
//  if (num_of_uploads > 0)
//  {
//    uint8_t buff1[max_upload_size] = {}; 
//    Serial.print("initialized buffer");
...
//      Serial.print("Sent a portion");
//      httpResponseCode = http.POST(buff1, sizeof(buff1)); 
//    }
//  }
//
...
//    http.addHeader("Content-Type", "application/octet-stream");
//    httpResponseCode = http.POST(buff2, sizeof(buff2));
//    Serial.print("sent other portion");
//  }
//
...
//   }
  ...
  delay(55000);  //Send a request every 10 seconds
