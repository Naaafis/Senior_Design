...
class Messages extends Component {
  ...
  renderMessage(message){
    ...
    console.log('this is the members username' + member.clientData.username);
    console.log(text);
    const { currentMember } = this.props;
    console.log('qwerwqerewerewerwerewerewerwewerew'+currentMember.username);
    const messageFromMe = member.id === currentMember.id;
    console.log('ahhhhhh' + member.id);
      ...
      <View style={outerName}>
        ...
        <View style={middleName}>
          {messageFromMe ? (
            ...
            <Text style={styles.Message_content_username}>{member.clientData.username}</Text>
          )}
